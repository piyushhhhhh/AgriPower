...
// Check if user is already logged in or has a valid remember me token
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="login.php" class="hover:text-green-200 transition underline">Login</a>
                </div>
